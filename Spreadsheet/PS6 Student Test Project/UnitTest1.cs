...
namespace PS6_Student_Test_Project
{
    [TestClass]
    public class UnitTest1
    {
        ...
        public void TestGetCellValue1()
        {
            ...
            ss.SetContentsOfCell("A2", "8");
            ss.SetContentsOfCell("A4", "=A1+A2");
            double x = (double)ss.GetCellValue("A4");
        ...
        {
            AbstractSpreadsheet ss = new Spreadsheet();
            ss.SetContentsOfCell("A2", "=5+5");
            ss.SetContentsOfCell("A1", "A2");
            Assert.AreEqual("A2", (string)ss.GetCellValue("A1"));
        }
 ...
 //           s.SetContentsOfCell("A5", "82.5");
            Assert.AreEqual(s.GetCellValue("A1"), 11.0);
        }

        [TestMethod]
        [ExpectedException(typeof(CircularException))]
        public void TestCellValue5()
        {
            Spreadsheet s = new Spreadsheet();
            s.SetContentsOfCell("A1", ("=A3+A2"));
            s.SetContentsOfCell("A2", "=A4+1");
            s.SetContentsOfCell("A3", ("=A4+A5"));
            s.SetContentsOfCell("A4", "20.5");
            s.SetContentsOfCell("A5", ("=A2+A3"));
            Assert.AreEqual(s.GetCellValue("A1"), 105);
        }

        [TestMethod]
        public void TestCellValue6()
        {
            Spreadsheet s = new Spreadsheet();
            s.SetContentsOfCell("A1", ("=A3+A2"));
            s.SetContentsOfCell("A2", "=A4+1");
            s.SetContentsOfCell("A3", ("=A4+A5"));
            s.SetContentsOfCell("A4", "20.5");
            s.SetContentsOfCell("A5", ("=1+A4"));
            Assert.AreEqual(s.GetCellValue("A1"), 63.5);
        }
        ...
        public void TestSaved()
        {
            ...
            s.SetContentsOfCell("A3", "TempVarMe");
            s.SetContentsOfCell("A4", "=A2*2");
            StreamWriter write = new StreamWriter("test.xml");
            s.Save(write);
        }
        ...
        {
            AbstractSpreadsheet f = new Spreadsheet();
            Assert.AreEqual(f.Changed, false);
        }
